...
namespace CoreAPIDemo
{
	...
	public class Content
	{
		...
		static public void AddStrokeTypes(Form1 Parent)
		{
			...
			CC.SetLineWidth(15);
			IPXC_Pattern Pat = crtImgPat(System.IO.Directory.GetParent(System.Environment.CurrentDirectory).Parent.FullName + "\\Images\\CoreAPI_32.ico", Parent.m_CurDoc, ixcInst);
